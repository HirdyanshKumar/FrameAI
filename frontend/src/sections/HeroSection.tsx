...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            <div className="absolute top-30 -z-10 left-1/4 size-72 bg-brand-purple blur-[300px]"></div>
            <motion.a href="/" className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-indigo-100 bg-indigo-200/15"
            ...
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop wasting hours on design. Get high-converting thumbnails in seconds with our AI</motion.p>
            ...
            >
                <button onClick={() => navigate('/generate')} className="bg-brand-purple hover:bg-indigo-700 text-white rounded-full px-7 h-11">
                    Generate Now
                </button>
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 md:gap-14 mt-12">
                {specialFeatures.map((feature, index) => (
                    ...
                    >
                        <CheckIcon className="size-5 text-brand-purple" />
