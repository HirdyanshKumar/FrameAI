...
import { SquareIcon, SparkleIcon, ImageIcon, PenToolIcon, CpuIcon, ChevronDown, ChevronDownIcon } from 'lucide-react';
...
const StyleSelector = ({value,onChange,isOpen,setIsOpen}: {value:ThumbnailStyle; onChange:(style:ThumbnailStyle) => void; isOpen:boolean; setIsOpen:(open:boolean) => void}) => {
    ...
    const styleDescriptions: Record<ThumbnailStyle,string> = {
        ...
        'Tech/Futuristic' : 'Hand-drawn , artistic , creative',
    }
  ...
  return (
    <div className='relative space-y-3 dark'>
        ...
        className='w-full flex items-center justify-between rounded-md border px-4 py-3 text-left transition bg-white/8 hover:bg-white/12 border-white/10 text-zinc-200'>
