  ...
  return (
    ...
    <div className='min-h-screen flex items-center justify-center'>
            <form
                ...
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-brand-blue/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <div className="flex items-center w-full mt-4 bg-white/5 ring-2 ring-white/10 focus-within:ring-brand-blue/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <div className=" flex items-center mt-4 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-brand-blue/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
                ...
                <button type="submit" className="mt-2 w-full h-11 rounded-full text-white bg-brand-purple hover:bg-brand-blue transition " >
                    {state === "login" ? "Login" : "Sign up"}
                </button>
